...
@Component({
  selector: 'app-long-break-timer',
  templateUrl: './long-break-timer.component.html',
  styleUrls: ['./long-break-timer.component.css'],
})
export class LongBreakTimerComponent implements OnInit {
  message: string = '';
  strMinutes: string = '';
  strSeconds: string = '';
