...
@Component({
  selector: 'app-short-break-timer',
  templateUrl: './short-break-timer.component.html',
  styleUrls: ['./short-break-timer.component.css'],
})
export class ShortBreakTimerComponent implements OnInit {
  message: string = '';
  strMinutes: string = '';
  strSeconds: string = '';
